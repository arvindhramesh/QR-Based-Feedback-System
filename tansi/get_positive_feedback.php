...
$q2 = "SELECT PARAMETER, COUNT(*) AS COUNT FROM tans.master_asset_data WHERE status = 'YES' GROUP BY PARAMETER order by 1";
...
// Histogram
$q3 = "SELECT PARAMETER, COUNT(*) AS COUNT FROM tans.master_asset_data WHERE status = 'YES' GROUP BY PARAMETER ORDER BY PARAMETER";
