...
<body>
  ...
  <nav>
    <ul class="menu">
      ...
      <ul class="dropdown">
          <li><a href="phd/university_phd_list.php">Ph.D Detail for All Univeristy</a></li>
          <li><a href="phd/import.php">Ph.D Excel Upload  </a></li>
          <li><a href="staff/university_staff_list.php">Staff Detail for All Univeristy</a></li>
      ...
      <li><a href="#">QR code</a> 
        <ul class="dropdown">
          <li><a href="newadd.php">Add Category and Parameter</a></li>
          <li><a href="newedit.php">Modif Category and Parameter </a></li>
